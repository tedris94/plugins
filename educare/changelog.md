...
- Fixed show/hide button issues from add or update student or teacher
- Fixed teachers publish results while adding marks
- Add new settings for allow teachers to publish results while adding marks
...
- Added template system for Search form, Results card and Certificate
- Added Certificate system
- Added Rattings system
- Added Remarks system
- Added Attendance system
- Added Individually marks input facilities
- Improved promote system
- Fixed marks publish issues (publish but not showing on front-end and all resuls list)
- Also, Fixed mark sheet seems it is not working. Moreover, the work independently
- Fixed Changed default field not appearing in Head of table when add marks
- Improve mark sheet save or publishing system
...
- Added Students and Teachers profiles and dashboards
- Added Password or PIN-based resuls access.
- Added Educare Admin, Teachers and Students roles
- Added more filtaring options
- Improved data pagination
- Improved Educare settings
...
- Added Add Marks (Marksheet) System
